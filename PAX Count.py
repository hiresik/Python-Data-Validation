...
r='C:\Docs\Lab 4\Data\SAP\PAX Count\Formatted\PAX_Count_Jan_2017_out_to be deleted.csv'
w='C:\Docs\Lab 4\Data\SAP\PAX Count\Formatted\Formatted with colon\PAX_Count_Jan_2017_out_with_colon.csv'
...
with open(r, 'r') as source:
    with open(w, 'w') as result:
        ...
        writer.writerow(['ACOWNER','FLTNUM','FLIGHTDATE','OPERTIME','FLIGHTDATE_UTC','OPERTIME_UTC','BOARD_POINT','DESTINATION','PAX_COUNT'])
        source.readline()
        for row in reader:
            # print row
            # ts0 = """+row[1]+"""
