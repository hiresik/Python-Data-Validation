...
r='C:\Docs\Lab 4\Data\SAP\FlightMovementType\New 09042018\FlightMvtMessageOctNovDec2017.csv'
w='C:\Docs\Lab 4\Data\SAP\FlightMovementType\New 09042018\FlightMvtMessageOctNovDec2017_out.csv'
...
with open(r, 'r') as source:
    with open(w, 'w') as result:
        ...
        writer.writerow(["ACOWNER","FLTNUM","FLIGHTDATE","DEPSTN","ARRSTN","MVTTYPE","MVTDATETIME","MVTDATETIMEUTC","EFFECTIVEFROM","EFFECTIVETO"])
